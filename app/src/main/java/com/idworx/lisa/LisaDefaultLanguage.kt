...
object LisaCoreVocabulary {
    ...
    private val entries: List<Entry> = listOf(
        Entry("hello", 1, 1, MultilingualPhrase("Hello", "Hallo", "Sawubona")),
        ...
        Entry("please", 2, 2, MultilingualPhrase("Please", "Asseblief", "Ngicela")),
        Entry("i_love_you", 2, 3, MultilingualPhrase("I love you", "Ek het jou lief", "Ngiyakuthanda")),
        Entry("yes", 2, 0, MultilingualPhrase("Yes", "Ja", "Yebo")),
        Entry("no", 0, 2, MultilingualPhrase("No", "Nee", "Cha")),
        ...
        Entry("i_need_help", 3, 3, MultilingualPhrase("I need help", "Ek het hulp nodig", "Ngidinga usizo")),
        ...
        Entry("i_need_food", 0, 4, MultilingualPhrase("I need food", "Ek het kos nodig", "Ngidinga ukudla")),
